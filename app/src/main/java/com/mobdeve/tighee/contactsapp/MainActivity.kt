...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        private const val CONTACTS_STRING_HOLDER_KEY = "CONTACTS_STRING_HOLDER_KEY"
    }
    ...
    override fun onStart() {
        ...
        var displayString = sp.getString(CONTACTS_STRING_HOLDER_KEY, "")
    ...
    override fun onPause() {
        ...
        editor.putString(CONTACTS_STRING_HOLDER_KEY, viewBinding.contactsStringHolderTv.text.toString())
        editor.apply()
        Log.d(TAG, "onPause: saved data")
    }
}